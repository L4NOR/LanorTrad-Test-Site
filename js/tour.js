...
(function () {
  ...
  const HOME = {
    ...
    steps: [
      { menu: false, eyebrow: "Bienvenue 👋", title: "Bienvenue sur LanorTrad",
        body: "Faisons ensemble un tour rapide du site (~30 s) pour repérer l'essentiel : lire, naviguer, chercher et suivre vos séries." },
      { target: ".hero-actions", menu: false, radius: 16, eyebrow: "Lecture", title: "Commencez à lire",
      ...
      { rect: navArcRect, menu: true, radius: 34, eyebrow: "Navigation", title: "Votre boussole",
      ...
      { target: '.rn-item[data-action="search"]', menu: true, round: true, eyebrow: "Recherche", title: "Trouvez une série en un éclair",
        body: "Cherchez par <strong>titre</strong> ou par <strong>genre</strong>. Astuce clavier : appuyez sur <strong>/</strong> n'importe où pour ouvrir la recherche." },
      { target: '.rn-item[href="bibliotheque.html"]', menu: true, round: true, eyebrow: "Votre espace", title: "Bibliothèque & suivis",
        body: "Reprenez votre lecture là où vous l'aviez laissée, et <strong>suivez vos séries</strong> (🔔) pour repérer les nouveaux chapitres d'un coup d'œil." },
      { target: '.rn-item[href="forum.html"]', menu: true, round: true, eyebrow: "Communauté", title: "Forum, XP & classement",
        body: "Créez un compte gratuit pour <strong>discuter sur le forum</strong>, gagner de l'<strong>XP</strong> en lisant et grimper au <strong>classement</strong>." },
      { target: '.rn-item[data-action="theme"]', menu: true, round: true, eyebrow: "Confort", title: "Choisissez votre ambiance",
        body: "Basculez le thème d'un tap : <strong>Sombre</strong>, <strong>OLED</strong> (noir pur, idéal la nuit) ou <strong>Clair</strong>." },
      { target: '.rn-item[data-action="perf"]', menu: true, round: true, eyebrow: "Fluidité", title: "Ça rame ? Passez en mode léger",
      ...
      { menu: false, eyebrow: "C'est parti 🎉", title: "Vous êtes prêt !",
        body: "Bonne lecture ✨ Vous pourrez <strong>revoir cette visite</strong> à tout moment via le lien « 🧭 Revoir la visite guidée » en bas de page." },
    ],
  };
  ...
  const FORUM = {
    ...
    steps: [
      ...
      { target: '#forum-bar [data-auth="signup"]', radius: 22, eyebrow: "1re étape", title: "Créez votre compte",
        body: "Cliquez sur <strong>« Créer un compte »</strong> : choisissez un <strong>pseudo</strong>, un <strong>email</strong> et un mot de passe. Vous recevez un email de confirmation, puis vous vous connectez via <strong>« Connexion »</strong>. C'est gratuit et indispensable pour publier, réagir et gagner de l'XP." },
      { target: "#forum-app .fo-cat", radius: 18, eyebrow: "S'y retrouver", title: "Les catégories",
        body: "Chaque <strong>catégorie</strong> regroupe un thème (annonces, discussions, propositions de séries…). Cliquez sur l'une d'elles pour voir ses <strong>sujets</strong>, puis sur un sujet pour lire la discussion." },
      { eyebrow: "Participer", title: "Lancer un sujet, répondre",
        body: "Une fois connecté, <strong>« + Nouveau sujet »</strong> lance une discussion. Dans un sujet, écrivez votre message puis <strong>« Répondre »</strong>. Vous pouvez <strong>mentionner</strong> quelqu'un avec <strong>@pseudo</strong> et <strong>réagir</strong> aux messages avec des emojis 👍." },
      { eyebrow: "À quoi ça sert ?", title: "Comprendre les badges",
        body: () => "<p>Les petits badges à côté d'un pseudo indiquent <strong>qui parle</strong> :</p>" + badgeLegend() +
                    "<p>Plus vous êtes actif, plus votre rang monte — il est aussi visible au <strong>classement</strong>.</p>" },
      { target: "#fo-bell", round: true, eyebrow: "Rester au courant", title: "Notifications & profil",
        body: "La <strong>cloche 🔔</strong> vous prévient des réponses à vos sujets et des <strong>@mentions</strong>. À côté de votre pseudo, l'<strong>engrenage ⚙️</strong> ouvre votre profil (avatar, âge, genres préférés…). Ces infos apparaissent quand on clique sur votre nom.",
        before: () => waitFor("#fo-bell", 1200) },
      { eyebrow: "À vous de jouer 🎉", title: "Bienvenue dans la communauté",
        body: "Une règle d'or : <strong>respect</strong> et <strong>pas de spoilers</strong> sans prévenir. Vous pourrez revoir ce tuto via le lien « 🧭 Revoir le tuto du forum » en bas de page. Bon forum !" },
    ],
  };
